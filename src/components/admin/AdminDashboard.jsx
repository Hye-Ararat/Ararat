        ...
        >
          ...
          <Box sx={{ overflow: "auto" }}>
            ...
            <List>
              ...
              <ListItem
                selected={props.page == "settings" ? true : false}
                button
                component={Link}
                to={`/admin/instance/${instance}/settings`}
                key="Settings"
              >
                <ListItemIcon>
                  <SettingsIcon />
              ...
              <ListItem
                selected={props.page == "api" ? true : false}
                button
                component={Link}
                to={`/admin/instance/${instance}/api`}
                key="API"
              >
                <ListItemIcon>
                  <APIIcon />
            ...
            <List>
              <ListItem
                ...
                button
                component={Link}
                to={`/admin/instance/${instance}/servers`}
                key="Servers"
              >
                <ListItemIcon>
                  <ServersIcon />
              ...
              <ListItem
                selected={props.page == "nodes" ? true : false}
                button
                component={Link}
                to={`/admin/instance/${instance}/nodes`}
                key="Nodes"
              >
                <ListItemIcon>
                  <NodesIcon />
