  ...
  const RenderStep = () => {
    switch (step) {
      case 0:
            ...
            <Card sx={{ width: 275, height: 305, m: 3 }}>
              ...
              <CardActions>
                <Button
                  ...
                  size="small"
                  onClick={() => {
                    setCollectedData({ ...CollectedData, type: "N-VPS" });
                    setStep(1);
                  }}
                >
                  Select
            ...
            <Card sx={{ width: 275, m: 3, height: 305 }}>
              ...
              <CardActions>
                <Button
                  ...
                  size="small"
                  onClick={() => {
                    setCollectedData({ ...CollectedData, type: "Docker" });
                    setStep(1);
                  }}
                >
                  Select
            ...
            <Card sx={{ width: 275, m: 3, height: 305 }}>
              ...
              <CardActions>
                <Button
                  ...
                  size="small"
                  onClick={() => {
                    setCollectedData({ ...CollectedData, type: "KVM" });
                    setStep(1);
                  }}
                >
                  Select
        ...
        break;
      case 1:
        var collectedCubes = data.filter(
          (cube) => cube.type == CollectedData.type
        );
                  ...
                  <Card sx={{ width: 275, m: 3 }}>
                    <CardMedia
                      ...
                      image={
                        cube.icon
                          ? cube.icon
                          : "https://cdn.pling.com/img/d/3/5/1/9c30e1a29f830fb3ee50c350e7e62476df63.png"
                      }
                      title="Contemplative Reptile"
                    />
                    <CardContent>
      ...
      case 3:
        if (versionStep != undefined) {
          return (
            <>
              {CollectedData.magmacube.images[CollectedData.version].map(
                (key) => {
                  return (
                    <Card sx={{ width: 275, m: 3 }}>
                      <CardContent>
