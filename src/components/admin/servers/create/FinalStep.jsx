...
function FinalStep(Data) {
  ...
  const nodes = [{ name: "NL-01", group: "Netherlands", id: 1 }];
  const port_binds = [
  ...
  function CreateServer() {
    ...
    axios
      .get("http://api.hye.gg:3000/api/v1/admin/magma_cubes")
      // eslint-disable-next-line no-unused-vars
      ...
      <FormGroup>
        ...
        <Paper variant="outlined">
          <Grid container direction="row">
            <Box sx={{ m: 2 }}>
              <Typography variant="normal" id="name" component="div">
                Server Name
              </Typography>
        ...
        <Paper variant="outlined">
          ...
          {user_count > 1 ? (
            <Button
              onClick={() => setUserCount(user_count - 1)}
              variant="contained"
              color="error"
              size="small"
              sx={{ m: 1 }}
