      ...
      if (instance_id == instance) {
        ...
        onSnapshot((docRef), (doc) => {
          ...
          if (current_instances.find(data => data.id == instance_id)){
            var instanceLoc = current_instances.findIndex(existing_instance => existing_instance.id == instance_id)
            if (doc.exists()){
              instance_data.id = instance_id
      ...
      <Hidden only={["sm", "xs"]}>
        ...
        >
          ...
          <Box sx={{ overflow: "auto" }}>
            <Divider />
            <List>
              <ListItem selected={props.page == "servers" ? true : false} button component={Link} to={`/instance/${instance}`} key='Servers'>
                <ListItemIcon>
                  <StorageIcon />
                </ListItemIcon>
              ...
              {is_admin == true ? <>
                <Divider />
            <List>
                <ListItem button component={Link} to={`/admin/instance/${instance}`} key='Admin'>
                  <ListItemIcon>
                    <AdminIcon />
                  </ListItemIcon>
                  <ListItemText
