...
function AccountContainerInstances() {
  ...
  function handleFieldChange(event) {
    ...
    var { current_password, new_password, new_password_confirm } =
      auth_data.password;
    ...
    if (
      event.target.id == "new_password_confirm" ||
      event.target.id == "new_password" ||
      event.target.id == "current_password"
    ) {
  ...
  return (
    <>
      ...
      <Typography mt={2} mb={1} variant="h6" component="h6">
      ...
      <Box component={Paper} variant="outlined">
        <Grid container direction="row">
          ...
          <Grid sx={{ m: 2 }}>
            <Typography
              ...
              fontWeight={500}
            >
              Email <Chip color="error" size="small" label={"Not Verified"} />
            </Typography>
            <TextField
              sx={{ width: "15rem" }}
              id="email"
        ...
        <Divider />
        <LoadingButton
          loading={setting_data}
          sx={{ m: 2 }}
          onClick={() => savePersonal()}
          variant="contained"
        >
          {successData ? <CheckIcon /> : "Save"}
        </LoadingButton>
      </Box>
        ...
        <Grid container direction="row">
          <Grid item sx={{ m: 2 }}>
            ...
            <TextField
              ...
              onChange={handleFieldChange}
              value={
                field_data.password.current_password
                  ? field_data.password.current_password
                  : ""
              }
            ></TextField>
            ...
            <TextField
              ...
              onChange={handleFieldChange}
              value={
                field_data.password.new_password
                  ? field_data.password.new_password
                  : ""
              }
            ></TextField>
            ...
            <TextField
              type="password"
              sx={{ mt: 2, width: "15rem" }}
              required={field_data.password.new_password ? true : false}
              id="new_password_confirm"
              label="Confirm New Password"
              onChange={handleFieldChange}
              value={
                field_data.password.new_password_confirm
                  ? field_data.password.new_password_confirm
                  : ""
              }
            ></TextField>
