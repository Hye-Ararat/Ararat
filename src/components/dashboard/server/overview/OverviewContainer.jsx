    ...
    <React.Fragment>
      ...
      <Paper sx={{ mt: 2 }}>
        <Grid container direction="row" sx={{ p: 2 }}>
          ...
          <Box sx={{ ml: 1 }}>
            ...
            >
              {minecraft_server_data ? (
                <div
                  style={{ marginTop: 3 }}
                  dangerouslySetInnerHTML={getMinecraftMotd()}
                />
              ) : (
                ""
              )}
          ...
          <Grid
            sx={{ ml: "auto", width: 216, height: "20" }}
            container
            direction="row"
            item
          >
            ...
            <Grid item container direction="row">
              ...
              <Button sx={{ m: "auto" }} color="error" variant="contained">
                Stop
              </Button>
              <Button sx={{ m: "auto" }} color="warning" variant="contained">
                Restart
              </Button>
            </Grid>
          </Grid>
      ...
      <Grid container direction="row" spacing={2}>
        <Grid item xs={12} md={2.5} lg={2}>
          <Paper sx={{ p: 1.5, mt: 2, height: "100%" }}>
            ...
            <Grid
              sx={{ width: 360, height: "20" }}
              container
              direction="column"
            >
              <Typography variant="normal">Server Address</Typography>
              <Typography style={{ marginBottom: 10 }} variant="normalNoBold">
                1.1.1.1
              </Typography>
              <Typography variant="normal">Server Version</Typography>
              <Typography style={{ marginBottom: 10 }} variant="normalNoBold">
                {minecraft_server_data ? minecraft_server_data.version : ""}{" "}
              </Typography>
        ...
        <Grid item md={5} xs={12} lg={3.5}>
          <Paper sx={{ p: 1.5, mt: 2, height: "100%", position: "relative" }}>
            ...
            <Grid container direction="row">
              <Grid sx={{ mt: 2 }} container direction="row">
                <img
                  sx={{ marginTop: 15 }}
                  height={30}
                  src="https://www.spigotmc.org/data/resource_icons/9/9089.jpg?1564514296"
                />
                <Typography style={{ marginLeft: 3 }} variant="normalNoBold">
                  EssentialsX
                </Typography>
                <Chip
                  sx={{ ml: "auto" }}
              ...
              <Grid sx={{ mt: 2 }} container direction="row">
                <img
                  sx={{ marginTop: 15 }}
                  height={30}
                  src="https://www.spigotmc.org/data/resource_icons/28/28140.jpg?1490821714"
                />
                <Typography style={{ marginLeft: 3 }} variant="normalNoBold">
                  LuckPerms
                </Typography>
              ...
              <Grid sx={{ mt: 2 }} container direction="row">
                <img
                  sx={{ marginTop: 15 }}
                  height={30}
                  src="https://www.spigotmc.org/data/resource_icons/19/19254.jpg?1475607356"
                />
                <Typography style={{ marginLeft: 3 }} variant="normalNoBold">
                  ViaVersion
                </Typography>
            ...
            <Typography sx={{ mt: 1, mb: 2 }} variant="body2">
              and <Typography variant="normal">7 other updates</Typography>
            </Typography>
            <Button
              sx={{ position: "absolute", bottom: 10 }}
              size="small"
            ...
            <Grid container direction="row" sx={{ mb: 5 }}>
              <Grid sx={{ mt: 2 }} container direction="row">
                <img
                  sx={{ marginTop: 15 }}
                  height={30}
                  src="https://crafatar.com/avatars/b68cea71-52a6-43df-85c3-2afd6bf0ded6"
                />
                <Typography style={{ marginLeft: 3 }} variant="normalNoBold">
                  Endermined
                </Typography>
              ...
              <Grid sx={{ mt: 2 }} container direction="row">
                <img
                  sx={{ marginTop: 15 }}
                  height={30}
                  src="https://crafatar.com/avatars/62ae805f-b78a-4dbb-ad46-b0cb24e26ec1"
                />
                <Typography style={{ marginLeft: 3 }} variant="normalNoBold">
                  Ctech321
                </Typography>
              ...
              <Grid sx={{ mt: 2 }} container direction="row">
                <img
                  sx={{ marginTop: 15 }}
                  height={30}
                  src="https://crafatar.com/avatars/fe742961-072b-432c-b929-8ca3b7a267e8"
                />
                <Typography style={{ marginLeft: 3 }} variant="normalNoBold">
                  WolfoGaming
                </Typography>
