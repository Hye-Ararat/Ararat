...
function SideBar(){
  ...
  <link href="/sb/sidebars.css" rel="stylesheet" />
  ...
  <main>
    <div className="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style={{width: '280px', height: '100vh'}}>
      <a href="/" className="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
        <img width={64} src="/images/logo.png"></img>
      </a>
      ...
      <div className="dropdown">
        <a href="#" className="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
          <img src="https://s.gravatar.com/avatar/7731827599bc45a356951f00f2b5466f?s=80&r=g" alt="" width={32} height={32} className="rounded-circle me-2" />
          <strong>Hye</strong>
        </a>
