...
export default function StateIndicator() {
    ...
    return (
        instance.monitor ? <Chip sx={{ marginLeft: "auto", marginTop: "auto", marginBottom: "auto" }} size="small" label={instance.monitor.state} color={instance.monitor.state == "Online" ? "success" : instance.monitor.state == "Starting" ? "warning" : instance.monitor.state == "Stopping" ? "warning" : "error"} /> : ""
    )
}