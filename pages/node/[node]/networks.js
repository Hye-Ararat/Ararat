...
function AddNetworkUser({ open, setOpen }) {
    ...
    <>
      ...
      {selectedNetwork ? (
        <>
          ...
          />
          <AddNetworkUser setOpen={setAddingNetworkUser} open={addingNetworkUser} selectedNetwork={selectedNetwork} />
        </>
      ) : (
        ""
      )}
      <SideLayout
        ...
        sections={[
          ...
          },
          {
            ...
            formatter: (item) => {
              return networks.find((net) => net.name === item)["user.permissions"] ? (
                ""
              ) : (
                <Grid container direction="column">
