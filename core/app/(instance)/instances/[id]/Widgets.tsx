...
*/
    return (
        ...
        {widgets.map((widget, index) => {
            return (
                <Grid key={index} container xs={widget.sizes?.xs} sm={widget.sizes?.sm} md={widget.sizes?.md} lg={widget.sizes?.lg} xl={widget.sizes?.xl} sx={{border: editingWidgets ? "dashed" : "", borderColor: "gray"}}>
